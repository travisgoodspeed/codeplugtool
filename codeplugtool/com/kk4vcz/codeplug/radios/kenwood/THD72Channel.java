...
public class THD72Channel implements Channel {
	/* Described on LA3QMA's page, the format is much like the D710G with a few extra fields.
	...
	int p8=0; //dcs status
	int p9=0; //cross tone
	int p10=8; //tone frequency
	int p11=8; //CTCSS frequency
	int p12=47; //DCS frequency
	int p13=0; //Cross tone?
	long p14=600000; //offset frequency in Hz, 8 digits
	int p15=0; //mode
	long p16=0; //TX freq in Hz, 10 digits
	int p17=0; //TX step size;
	int p18=0; //lock out
	...
	public static void main(String[] args) {
		...
		String me="ME 015,0147030000,0,1,0,1,0,0,0,09,09,000,0,00600000,0,0000000000,0,0";
		String mn="MN 015,W3QV";
		
		THD72Channel ch=new THD72Channel(me, mn);
	...
	public THD72Channel(String me, String mn) {
		...
		try {
			...
			System.out.format("Warning: '%s' is not a valid step size.  Ignoring.\n", words[3]);
		}
	...
	public THD72Channel(Channel src) throws IOException {
		Main.ApplyChannel(this, src);
	}
	
	public String renderme() {
		return String.format("ME %03d,%010d,%d,%d,%d,%d,%d,%d,%d,%02d,%02d,%03d,%d,%08d,%d,%010d,%d,%d", 
